...
import parcofaunistico.controller.RegistrazioneAnimaleController;
import parcofaunistico.data.Parametri;
import parcofaunistico.model.WritingModel;

public class RegAnimaliPanel extends JPanel {
    ...
    private final JTextField nome_scientifico, nome_comune, abitudini, nomeHabitat, nomeEsemplare;
    private final JTextField sesso, eta, altezza, peso, alimento, numero_pasti;
    private final JCheckBox malato;
    private final JButton sendButton;
    private final Map<Parametri, JTextField> textfields;
    private final RegistrazioneAnimaleController regController;

    public RegAnimaliPanel(final MainView mainView, final WritingModel writingModel) {
        ...
        this.nome_comune = createField();
        this.abitudini = createField();
        this.nomeHabitat = createField();
        this.nomeEsemplare = createField();
        this.sesso = createField();
        ...
        this.textfields.put(Parametri.NOME_COMUNE, nome_comune);
        this.textfields.put(Parametri.ABITUDINI, abitudini);
        this.textfields.put(Parametri.NOME_HABITAT, nomeHabitat);
        this.textfields.put(Parametri.NOME_ESEMPLARE, nomeEsemplare);
        this.textfields.put(Parametri.SESSO, sesso);
        ...
        this.regController = new RegistrazioneAnimaleController(writingModel);
    }
    ...
    private void arrangeComponents(JPanel panel) {
        ...
        addRow("Nome comune: ", nome_comune, ++row, gbc, panel);
        addRow("Abitudini: ", abitudini, ++row, gbc, panel);
        addRow("Nome Habitat: ", nomeHabitat, ++row, gbc, panel);
        addRow("Nome Esemplare: ", nomeEsemplare, ++row, gbc, panel);
        addRow("Sesso: ", sesso, ++row, gbc, panel);
